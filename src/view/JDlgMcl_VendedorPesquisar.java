...
public class JDlgMcl_VendedorPesquisar extends javax.swing.JDialog {
     ...
     */ 
    public JDlgMcl_VendedorPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setTelaPai(JDlgMcl_Vendedor jDlgMcl_Vendedor){
        this.jDlgMcl_Vendedor = jDlgMcl_Vendedor;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMcl_VendedorPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMcl_VendedorPesquisar dialog = new JDlgMcl_VendedorPesquisar(new javax.swing.JFrame(), true);
