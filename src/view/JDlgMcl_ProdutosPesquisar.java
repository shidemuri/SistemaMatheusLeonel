...
public class JDlgMcl_ProdutosPesquisar extends javax.swing.JDialog {
     ...
     */ 
    public JDlgMcl_ProdutosPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setTelaPai(JDlgMcl_Produtos jDlgMcl_Produtos){
        this.jDlgMcl_Produtos = jDlgMcl_Produtos;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMcl_ProdutosPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMcl_ProdutosPesquisar dialog = new JDlgMcl_ProdutosPesquisar(new javax.swing.JFrame(), true);
