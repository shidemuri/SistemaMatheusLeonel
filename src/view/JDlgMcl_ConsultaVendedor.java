...
// CONTRAPONTO 4: https://www.youtube.com/watch?v=7h7bnYA1LXE

public class JDlgMcl_ConsultaVendedor extends javax.swing.JDialog {
    ...
    public JDlgMcl_ConsultaVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMcl_ConsultaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMcl_ConsultaVendedor dialog = new JDlgMcl_ConsultaVendedor(new javax.swing.JFrame(), true);
