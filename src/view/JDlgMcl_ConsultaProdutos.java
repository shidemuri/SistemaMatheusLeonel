...
public class JDlgMcl_ConsultaProdutos extends javax.swing.JDialog {
    ...
    /**
     * Creates new form JDlgMcl_ConsultaProdutos
     */
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        MclProdutos flandrescarlet = new MclProdutos();
        flandrescarlet.setMclModelo("Consultando, aguarde...");
        controller.setlist(new ArrayList());
        controller.addBean(flandrescarlet);
        List remiliascarlet = (List) consultadao.listAllGe(new MclProdutos(), jTxtNome.getText(), jTxtCriterio.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgMcl_ConsultaProdutos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgMcl_ConsultaProdutos dialog = new JDlgMcl_ConsultaProdutos(new javax.swing.JFrame(), true);
